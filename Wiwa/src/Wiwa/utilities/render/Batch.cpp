...
namespace Wiwa {
	Batch::Batch(uint32_t max_vertices) : m_UsedQuads(0), m_MaxQuads(max_vertices)
	{
		m_Color = { 1.0f, 1.0f, 1.0f, 1.0f };

		m_BatchingShader = new Shader();
		m_BatchingShader->Init("../Assets/Resources/Shaders/model_color");
